...
class NiveauIntermediaire extends StatefulWidget {
  const NiveauIntermediaire({super.key});

  @override
  State<NiveauIntermediaire> createState() => _NiveauIntermediaireState();
}

enum snake_Direction {HAUT, BAS, GAUCHE, DROITE}

class _NiveauIntermediaireState extends State<NiveauIntermediaire> {
