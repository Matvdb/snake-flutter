...
class Difficile extends StatefulWidget {
  const Difficile({super.key});

  @override
  State<Difficile> createState() => _DifficileState();
}

enum snake_Direction {HAUT, BAS, GAUCHE, DROITE}

class _DifficileState extends State<Difficile> {
